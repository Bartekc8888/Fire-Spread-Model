...
public class SpeedButtons : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        startButton.GetComponent<Button>().onClick.AddListener(() => HandleButtonClick(startButton, 1));
        fasterButton.GetComponent<Button>().onClick.AddListener(() => HandleButtonClick(fasterButton, 3));
        fastestButton.GetComponent<Button>().onClick.AddListener(() => HandleButtonClick(fastestButton, 10));
